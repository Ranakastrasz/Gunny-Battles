...
//	public static float MISSILE_DAMAGE_BONUS = 25f;
	...
	private static float PD_RANGE = 90;
	public static float FIGHTER_DAMAGE_BONUS = 10f;
	public static float MISSILE_DAMAGE_BONUS = 10f;
	
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		
		float mult = com.fs.starfarer.api.impl.hullmods.MilitarizedSubsystems.getEffectMult(stats);
	...
	public String getDescriptionParam(int index, HullSize hullSize) {
		float mult = com.fs.starfarer.api.impl.hullmods.MilitarizedSubsystems.getEffectMult(null);
